...
//				FT8_cmd_dl(DL_COLOR_RGB | WHITE);
				...
				FT8_cmd_number(120, FT8_VSIZE - 35, 26, FT8_OPT_RIGHTX|5, num_profile_a); /* duration in µs of TFT_loop() for the touch-event part */
				FT8_cmd_number(120, FT8_VSIZE - 20, 26, FT8_OPT_RIGHTX|5, num_profile_b); /* duration in µs of TFT_loop() for the display-list part */
