...
int main(void)
{
	...
	TFT_init();
	set_spi_speed(3); /* speed up to 15MHz after init, with 20MHz touch is not working on my HW... */ /* 120 / (2 * (baudval + 1)) -> @120Mhz: 0 = 60MHz, 1 = 30MHz, 2 = 20MHz, 3 = 15MHz, 4 = 12MHz, 5 = 10MHz */
